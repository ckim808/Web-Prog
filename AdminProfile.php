			...
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li ><a href="DelivPage.php">Deliverables</a><li>
						...
						<li><a href="CalPage.php">Calender</a></li>
					</ul>
				</div>
...
<a href="javascript: jQuery.facebox({ajax:'ProfilePopUp.php'});" class = "btn btn-sm btn-primary" role = "button"> Edit Profile </a>
<br><br>
<div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title">Name and Personal Information</h3>
            </div>
            <div class="panel-body">
              First Name: Matthew <br>
			  Middle Name: Charles <br>
			  Last name: Milideo<br>
			  Gender: Male<br>
			  Race: Caucasian<br>
			  Age: 21<br>
			  Year: Senior<br>
  ...
  <div class="panel panel-success">
            ...
            <div class="panel-body">
              Email Address: mmilideo@stevens.edu<br>
			  Phone Number: 856-XXX-XXXX<br>
			  Mailing Address: 123 Place Ave. Town NJ 00000<br>
            </div>
          </div>

          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Account Picture</h3>
              </div>
            <div class="panel-body">
            <img src="data/ProfPic.jpg" class="img-responsive" alt="Responsive image">
